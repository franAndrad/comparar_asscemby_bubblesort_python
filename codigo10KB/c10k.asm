...
buffer db 10240 dup(?)       ; Buffer para almacenar los datos leidos 10KB
arr db 10240 dup(?)          ; Arreglo para los datos leidos 10KB
size_arr equ 10240           ; Tamaño del arreglo 
